...
export class OfficesComponent {
  ...
  officeRecord() {
    this.http
      .post('http://192.168.0.55:5000/office/getoffice', {})
      .subscribe((office) => {
  ...
  addOffice(formdata) {
    ...
    this.http
      .post('http://192.168.0.55:5000/office/addoffice', jsonform)
      .subscribe((office) => {
        console.log(office);
      });
  }
  ...
  updateOffice() {
    ...
    this.http
      .put('http://192.168.0.55:5000/office/updateoffice', formData)
      .subscribe((user) => {
  ...
  deleteOffice() {
    this.http
      .delete('http://192.168.0.55:5000/office/deleteoffice')
      .subscribe((data) => {
